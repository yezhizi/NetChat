...
ExternalProject_Add(protobuf
        PREFIX protobuf # 外部项目的根目录
        DEPENDS zlib    # 项目的依赖
        URL ${PROTOBUF_URL} # URL下载方式
        URL_MD5 ${PROTOBUF_MD5}
        TMP_DIR ${TMP_DIR}/protobuf 
        UPDATE_COMMAND ""
        BINARY_DIR protobuf/protobuf-build # 生成的目标文件所在的目录
        STAMP_DIR protobuf/protobuf-stamp # 保存下载的状态文件的目录
        DOWNLOAD_DIR ${TMP_DIR} # 下载目录
        SOURCE_DIR ${CMAKE_CURRENT_BINARY_DIR}/protobuf/src/protobuf    # 将下载内容解压到的目录，对于非URL下载的方式，也可以在里面预先存放下载好的文件
        SOURCE_SUBDIR cmake # 相对于SOURCE_DIR下的目录，procotolbuf的cmakelist文件位于其cmake文件夹下
        BUILD_BYPRODUCTS "" # 取消生成构建产品
        CMAKE_CACHE_ARGS
        ...
        -Dprotobuf_BUILD_SHARED_LIBS:BOOL=${PROTOBUF_BUILD_SHARED_LIBS} # 构建动态库选项，查看protobuf的选项设置
        -Dprotobuf_BUILD_TESTS:BOOL=OFF # protobuf的测试选项
...
add_library(protobuf_imported UNKNOWN IMPORTED) # 生成一个导入的库

set_property(TARGET protobuf_imported PROPERTY IMPORTED_LOCATION "${PROTOBUF_STATIC_LIBRARIES}")    # 设置导入库的路径